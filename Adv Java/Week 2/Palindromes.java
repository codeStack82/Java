    ...
    public static void main(String[] args) {
        String input = "";
         ...
         if(args.length>0){                                                     //Get user input from console
            ...
            System.out.println("Your input palidrome string is: "+ input);
        }
        else{                                                                   //Get user input
            Scanner in = new Scanner(System.in);
            System.out.print("Please enter palindrome to test: ");
            input = in.nextLine();
        }
        ...
        if(input.equals("")){
            ...
            System.out.println("\nThe input \"" + input + "\" is in Strict format.");
           
        }else if(isOrdinary){
            System.out.println("\nThe input \"" + input + "\" is in Ordinary format.");
           
        }else{
            System.out.println("\nThe input \"" + input + "\" is in not a palindrome.");
        }   
    }
